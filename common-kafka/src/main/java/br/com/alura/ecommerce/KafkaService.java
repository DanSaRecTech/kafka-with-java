...
import br.com.alura.ecommerce.GsonDeserializer;
...
public class KafkaService<T> implements Closeable {
    ...
    public KafkaService(String topic, ConsumerFunction parse, Class<T> type, Map<String, String> properties) {
        this(parse, topic, type, properties);
    }
